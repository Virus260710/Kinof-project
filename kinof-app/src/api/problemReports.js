...
export function updateProblemReportStatus(id, status, adminComment) {
...
export function updateProblemReportStaffNote(id, staffNote) {
  return apiFetch(`/api/problem-reports/${id}/staff-note`, {
    method: "PATCH",
